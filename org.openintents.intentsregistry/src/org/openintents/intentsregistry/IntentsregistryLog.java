...
public class IntentsregistryLog {
	   /**
	   ...
	   public static IStatus createStatus(int severity, int code, String message,
				Throwable exception) {
			return new Status(severity, IntentsregistryActivator.PLUGIN_ID, code,
					message, exception);
		}
	    ...
	    */
		public static void log(IStatus status) {
			IntentsregistryActivator.getDefault().getLog().log(status);
		}
}
